...
function Travel_Home_Past() {
  ...
  useEffect(() => {
    const fetchTrips = async () => {
      ...
      const tripsNotTaken = trips.filter(trip => trip.trip_taken === true); //Filter Based on Trips Not Taken
...
export default Travel_Home_Past
