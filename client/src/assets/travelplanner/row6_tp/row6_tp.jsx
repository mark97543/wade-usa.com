...
const Row6_tp = () => {
    const {setReturnFlight, returnFlight, arrFlightChkd, selectedTrip}=useContext(TPContext)
    ...
    const NewItem = ()=>{
        ...
        AddFlight(newData, "arrivingflights")
        //Need to Push to DB here. 
        setReturnFlight("")//Clears And Forces A
    ...
    const SaveRow = ()=>{
        ...
        EditFlight(newData, 'arrivingflights')
    ...
    const deleteItem = ()=>{
        DeleteFlight(rowID, 'arrivingflights')
        setEditItem(true)
        setRowID("")
        setNewDate("")
        setNewOrigin("")
    ...
    return (
        <div id='r2_out2_div' hidden={!arrFlightChkd}>
            <div id='r2_out_div' >
                <div id='dep_flight_div'>
                    <label id='dep_flight_label'>Returning Flights</label>
                </div>
                ...
                {Array.isArray(returnFlight) && returnFlight.map((flight,index)=>(
